      ...
      <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1">
            <span className="font-bold text-on-surface truncate text-xs sm:text-base">{username}</span>
            {verified && <VerifiedBadge />}
          </div>
          <span className="text-on-surface-variant text-[10px] sm:text-sm">{handle}</span>
        </div>
        <TwitterIcon className="size-4 sm:size-5 text-on-surface shrink-0" />
      </div>

      {/* Content */}
      <p className="text-on-surface text-xs sm:text-[15px] leading-relaxed mb-2 sm:mb-3 line-clamp-3 sm:line-clamp-4">
        {content}
      </p>

      {/* Footer */}
      <div className="flex items-center justify-between text-on-surface-variant text-[10px] sm:text-sm mt-auto">
        <span>{date}</span>
...
export default function Testimonials({ cards }) {
  ...
  const defaultCards = [
    {
      className:
        "[grid-area:stack] hover:-translate-y-10 before:absolute before:w-[100%] before:outline-1 before:rounded-2xl before:outline-outline-variant before:h-[100%] before:content-[''] before:bg-blend-overlay before:bg-background/60 grayscale-[100%] hover:before:opacity-0 before:transition-opacity before:duration-500 hover:grayscale-0 before:left-0 before:top-0",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop",
      username: "Miguel",
      handle: "@migueldata",
      content: "Venía de un sector diferente. Usé el relato de 'puesto híbrido' y ahora soy Coordinador de Transporte analizando datos con Tableau y Power BI. Gracias al sistema, conseguí el puesto que siempre soñé. 🔥",
      date: "Feb 15, 2026",
      verified: true,
      likes: 342,
      retweets: 82,
    ...
    },
    {
      ...
      username: "Francisco",
      handle: "@francisco_data",
      content: "Tenía mucha experiencia pero estaba estancado. Aplicué los cambios del sistema y a los 3 meses logré un puesto de Manager en una Big Four. El ROI de este curso es increíble. 📈",
      date: "Feb 10, 2026",
      verified: true,
      likes: 428,
      retweets: 95,
    ...
    },
    {
      ...
      username: "Antoni",
      handle: "@antoni_analyst",
      content: "Soy ingeniero con 2 años de experiencia no relacionada. Seguí los pasos al pie de la letra y conseguí mi primer puesto como Data Analyst junior. Sin este sistema, seguiría esperando. 💪",
      date: "Feb 5, 2026",
      verified: true,
      likes: 516,
      retweets: 123,
